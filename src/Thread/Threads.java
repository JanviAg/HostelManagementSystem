   ...
   public Threads(String name)
   {
    ...
    public void run()
    {
           ...
           else if(t.toString().contains("Db_Thread"))
           {
             ...
             sql = "INSERT INTO `users` (`id`,`name`,`father_name`, `cnic`, `date_of_birth`, `eductionLevel`, `college_name`, `securityFee`) VALUES"
                   + " ('"+s.getid()+"','"+s.getName()+"', '"+s.getFatherName()+"',  '"+s.getCnic()+"', '"+s.getDateOfBirth()+"', '"+s.getEducationLevel()+"', '"+s.getCollegeName()+"','"+s.getSecurityFee()+"');";
